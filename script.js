document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    const validators = {
      ...
      text: function(value, input) {
        if (input.hasAttribute('required') && !value.trim()) {
          return 'This field is required';
        }
        if (input.hasAttribute('minlength') && value.trim().length < parseInt(input.getAttribute('minlength'))) {
          return 'Minimum ' + input.getAttribute('minlength') + ' characters required';
        }
        return '';
      },
      textarea: function(value, input) {
        if (input.hasAttribute('required') && !value.trim()) {
          return 'This field is required';
        }
        if (input.hasAttribute('minlength') && value.trim().length < parseInt(input.getAttribute('minlength'))) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '4b9ebe61-99aa-4aeb-8497-cce6ad295cbc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '4b9ebe61-99aa-4aeb-8497-cce6ad295cbc';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '4b9ebe61-99aa-4aeb-8497-cce6ad295cbc';
